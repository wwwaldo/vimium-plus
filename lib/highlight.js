...
class ElementHighlighter {
    ...
    toggleVisualization() {
        // Removed cursor mode - highlighter only handles highlight boxes now
        return;
    }
    ...
    highlightClickableElements() {
        ...
        clickableElements.forEach(element => {
          element.rects.forEach(rect => {
            ...
            highlight.dataset.tagName = element.metadata.tagName;
            highlight.dataset.title = element.metadata.title;
            highlight.dataset.href = element.metadata.href;
            highlight.dataset.ariaLabel = element.metadata.ariaLabel;
            highlight.dataset.text = element.metadata.text;
            highlight.dataset.innerText = element.metadata.innerText;
            highlight.dataset.displayText = element.metadata.displayText;
