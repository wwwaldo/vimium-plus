...
// WARNING: Do not call findClickableElements() directly!
// Instead use navigator.refresh() which manages the global element state.
// This ensures proper state management and position tracking.
class ElementFinder {
    constructor() {
    }
